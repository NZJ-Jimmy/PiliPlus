...
/// [PlatformVideoController.pictureInPicture].
///
/// This fork ships an iOS implementation only. Android Picture-in-Picture is
/// handled elsewhere (e.g. via JNI). The imperative API is available for
/// advanced use cases (manual start/stop, lifecycle observation).
abstract class PictureInPictureController {
  ...
  /// [PlatformVideoController]. [videoSize] is the intrinsic video size used
  /// for the aspect ratio of the Picture-in-Picture window. When [autoEnter]
